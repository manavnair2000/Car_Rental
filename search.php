...
include './db.php';
try{
	if(isset($_SESSION['userid'],$_POST['search_key']))
	{
    $book = $_POST['search_key'];
    $sql="SELECT carRegNo,carName,carPrice,carFile FROM car_rental.car WHERE carName LIKE '%$book%';";
